 ...
 * GenUI design tokens.
 *
 * Keep this file aligned with tokens.scss.
 * Components should consume semantic tokens rather than raw visual values.
 */
...
/**
 * Applies CSS variable overrides to a target element.
 * Useful for runtime themes without changing component markup.
 */
...
/**
 * Returns a token by dot path, e.g. getToken('spacing.5') -> '16px'.
 */
